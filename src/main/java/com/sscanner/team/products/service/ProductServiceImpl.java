...
public class ProductServiceImpl implements ProductService {
    ...
    public Map<String, Object> findAllWithImgs(Pageable pageable) {
        ...
        return createPagedResponse(productWithImgDtos, products);
    }
    ...
    private Map<String, Object> createPagedResponse(List<ProductWithImgResponseDto> productWithImgDtos, Page<Product> products) {
